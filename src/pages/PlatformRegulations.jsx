    ...
    <div className="my-10">
      <main className="font-inter">
        ...
        <section className="my-2">
          <span className="mb-3 text-sm underline uppercase">1. Funzionalità della piattaforma</span>
          <ol className="text-xs">
            ...
            <li>
              ...
              <ul className="py-4 pl-6 list-disc list-inside">
                <li>1. registrazione e accesso alla Piattaforma (articolo 3);</li>
                <li>2. compilazione dell’Ordine di Acquisto (articolo 4);</li>
                <li>3. trasmissione dell’Ordine di Acquisto e pagamento attraverso la Piattaforma (articolo 5);</li>
                <li>4. accettazione dell’Ordine di Acquisto da parte di Eoreka (articolo 6).</li>
              </ul>
            </li>
            <li>
        ...
        {/* DEFINIZIONI */}
        <section className="my-2">
          <span className="mb-3 text-sm underline uppercase">2. Definizioni</span>
          <p className="text-xs">
          ...
          <ul className="py-4 pl-6 text-xs list-disc list-inside">
        ...
        {/* REGISTRAZIONE */}
        <section className="my-2">
          <span className="mb-3 text-sm underline uppercase">3. Registrazione alla piattaforma</span>
          <ol className="text-xs">
            <li>
            ...
            <li>
              ...
              <ul className="py-4 pl-6 text-xs list-disc list-inside">
                <li>1. selezionare la zona geografica di interesse;</li>
                <li>2. indicare l’Indirizzo E-Mail;</li>
                <li>3. inserire e confermare una password di accesso;</li>
                <li>4. selezionare la categoria di utenza cui appartiene;</li>
                <li>5. prestare il consenso al trattamento dei dati personali per le finalità indicate e alla cessione dei dati al Grossista per la Consegna dei Prodotti;</li>
                <li>6. accettare espressamente il presente Regolamento e</li>
                <li>7. inserire almeno un recapito di consegna.</li>
              </ul>
            </li>
            <li>
        ...
        {/* COMPILAZIONE */}
        <section className="my-2">
          <span className="mb-3 text-sm underline uppercase">4. Compilazione degli ordini</span>
          <ol className="text-xs">
            <li>
        ...
        {/* TRASMISSIONE */}
        <section className="my-2">
          <span className="mb-3 text-sm underline uppercase">5. Trasmissione degli ordini</span>
          <ol className="text-xs">
        ...
        {/* ACCETTAZIONE */}
        <section className="my-2">
          <span className="mb-3 text-sm underline uppercase">6. Accettazione e conferma degli ordini</span>
          <ol className="text-xs">
            ...
            <li>
              ...
              <ol className="py-4 pl-6 text-xs list-decimal list-inside">
        ...
        {/* CONSEGNA */}
        <section className="my-2">
          <span className="mb-3 text-sm underline uppercase">7. Consegna e fatturazione</span>
          <ol className="text-xs">
        ...
        {/* CANCELLAZIONE */}
        <section className="my-2">
          <span className="mb-3 text-sm underline uppercase">8. Cancellazione del profilo</span>
          <p className="text-xs">
        ...
        <section className="mb-2">
          <span className="mb-3 text-sm underline uppercase">9. Disposizioni finali</span>
          <ol className="text-xs">
